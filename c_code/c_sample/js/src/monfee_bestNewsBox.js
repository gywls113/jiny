...
(function($){
    var url = '../img/monkey/new_menu/'
    var newsData = [
        {title: '새로운 메뉴1',
         link: '#',
         img: 'menu_01.png',
         content:'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit sapiente, accusantium repellendus et accusamus, kang hyo jin.'},
        {title: '새로운 메뉴2',
         link: '#',
         img: 'menu_02.png',
         content:'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit sapiente, accusantium repellendus et accusamus, kang hyo jin.'},
